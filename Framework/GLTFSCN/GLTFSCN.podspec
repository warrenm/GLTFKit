Pod::Spec.new do |s|
  ...
  s.source_files        = "Framework/GLTFSCN/*.h", "Framework/GLTFSCN/Headers/*.h", "Framework/GLTFSCN/Source/*.m"
  s.public_header_files = "Framework/GLTFSCN/*.h", "Framework/GLTFSCN/Headers/*.h"
